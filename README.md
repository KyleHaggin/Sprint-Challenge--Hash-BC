...
Access has runtime complexity of O(n). Adding and removing from the front has runtime complexity of O(n). Adding and removing form the back has runtime complexity of O(1).
